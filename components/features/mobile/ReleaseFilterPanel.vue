        ...
        <div class="genre-dropdown__maingenre">
          <div class="expandable">
            <div 
              ...
              <div 
                class="genre-name" 
                @click="routeTo(mainGenre)">{{ mainGenre.name }}</div>
              <div class="arrow-box">
                <div :class="['arrow', selected !== i ? 'arrow-down' : 'arrow-up']"/>
              </div>
            </div>
              ...
              <template v-for="(genre, j) in mainGenre.genres">
                <template v-if="genre.parentGenre">
                  <div
                    ...
                    :key="`sub-genre-${j}`"
                    class="expandable__details__item"
                    @click="routeTo(genre, true)">
                    {{ genre.name }}
                  </div>
                </template>
                <template v-else>
                  <div
                    :key="`sub-genre-${j}`"
                    class="expandable__details__item"
                    @click="$router.push({name: 'genres-slug', params: {slug: genre.slug, genre: genre}})">
                    {{ genre.name }}
                  </div>
                </template>
              </template>
