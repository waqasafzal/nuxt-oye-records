      ...
      <div class="navbar__brand-box">
        <div class="row no-gutters">
          ...
          <div class="col-4 col-lg-9 col-sm-8">
            <main-navbar class="d-none d-lg-block"/>
          </div>
          <search class="col-2 col-lg-2 col-sm-1"/>
          <nuxt-link 
            :to="{name: 'cart'}" 
            class="d-inline-block vmargin-auto d-lg-none col-2 col-sm-1 cart__icon">
            <div class="cart-icon-box d-flex justify-content-center">
              <cart-svg class="vmargin-auto"/>
              <span :class="['badge', cartItemCount === 0 ? reservationCount > 0 ? 'reserve': 'empty' : '']"/>
            </div>
          </nuxt-link>
          <div class="col-2 col-sm-1 menu-icon-mobile d-lg-none">
            <div 
              class="d-flex vmargin-auto" 
              style="margin-left: auto; padding-top: 8px;">
              <div 
                class="burger-menu" 
...
export default {
  ...
  computed: {
    ...mapGetters(['cartItemCount', 'reservationCount', 'showMobile']),
    cartCount() {
