<template>
  <transition 
    ...
    @enter="onEnter">
    <div 
      v-if="!this.$store.getters.minimizedAudioPlayer" 
      ref="playlist" 
      class="playlist">
      <div 
        ...
        :ref="'track-'+i"
        :key="'track-'+i"
        class="playlist__item d-none d-md-flex" 
      ...
      <div 
        ...
        :ref="'track-'+i"
        :key="'track-'+i"
        class="playlist__item d-sm-block d-md-none" 
        @click="playTrack(track)">
        <div class="play-box">
          <div :class="[isPlaying(i) ? 'playing': '']">
            <play-release-button 
        ...
        <div class="d-flex flex-row">
          <div 
            class="d-flex flex-column track-info-panel" 
            style="width: 100%;">
            <div class="track-info">
              <div class="playlist-position">{{ i + 1 }}.</div>
...
if (process.browser) {
  elementInViewport = function(el, playlist) {
    ...
    return (
      itemRect.top >= playlistRect.top && itemRect.bottom <= playlistRect.bottom
    )
  }
}
